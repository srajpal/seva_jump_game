...
- **Spring assist** helps when a broken row leaves the next platform out of jumping reach: after about three seconds without climbing, the platform you are bouncing on becomes a spring, and if even a spring cannot clear the gap, helper platforms appear to bridge it.
