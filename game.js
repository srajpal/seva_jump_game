(() => {
  ...
  ui.pauseButton.addEventListener('click', pauseGame); ui.resume.addEventListener('click', resumeGame); ui.pauseRestart.addEventListener('click', () => start(state?.mode || 'endless')); ui.pauseHome.addEventListener('click', leaveRunEarly);
